...
namespace Sample.Wcf
{
    ...
    public class SampleService : ISampleService
    {
        ...
        /// </summary>
        private static DbConnection GetConnection(MiniProfiler profiler = null)
        {
            using (profiler.Step("GetOpenConnection"))
            {
                var cnn = new System.Data.SQLite.SQLiteConnection(WcfCommon.ConnectionString);
        ...
        {
            var profiler = WcfMiniProfiler.Current;
